    ...
    <div class="info-content-block-about guide">
        ...
        <details name="faq">
          ...
          <div class="content-about">
            ...
            <p class="text-about"><strong>IMPORTANT!</strong> - To make a choice, do not forget to click the "Choose" buttons in each of the lists.</p>
        ...
        <details name="faq">
          ...
          <div class="content-about">
            ...
            <p class="text-about"><strong>IMPORTANT!</strong> - to save your results, be sure to press the 7 - "Exit" button.</strong></p>
