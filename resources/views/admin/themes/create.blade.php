...
@section('title', 'Admin.Themes.Create')
...
@section('content')
  <div class="admin-content">
    ...
    @if ($errors->any())
      ...
      @endforeach        
    @endif
    <form method="post" action="{{ route('admin.themes.store') }}" class="form-input admin">
      @csrf
      ...
      <div class="input-box admin" name="title-box">
        ...
        <input type="text" class="input-text" name="title_base" id="title_base" value="{{ old('title_base') }}" @error('title_base') is-invalid @enderror>              
      </div>
