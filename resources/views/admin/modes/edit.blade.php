...
@section('title', 'Admin.Modes.Edit')
  ...
  <div class="admin-content">
    ...
    <form method="post" action="{{ route('admin.modes.update', ['mode' => $mode]) }}" class="form-input admin">
      ...
      <div class="input-box" name="description-box">
        ...
        <textarea class="input-text area" name="description" id="description">{{ $mode->description }}</textarea>            
      </div>     
      <div class="input-box" name="image-box">
        <div class="input-group">
          <div class="input-box mini edit" name="id-box">
            ...
            <input type="text" class="input-text notread" name="id-field" id="id-field" value="{{ $mode->id }}" readonly>            
          </div>
          ...
          <div class="input-box mini" name="status-box">
            ...
            <select class="input-text" name="status" id="status">
              @foreach ($statuses as $status)
                 <option @if($mode->status === $status) selected @endif>{{ $status }}</option> 
              @endforeach              
            </select>
          </div>
        </div>
