...
<div class="admin-content">
  ...
  <div class="chart-rows-block">
    <div class="chart-mini-row">
      <div class="chart-mini" name="chartModes">
        <canvas id="testChart2"></canvas>
      </div>
      <div class="chart-mini" name="chartLangs">
        <canvas id="testChart3"></canvas>
      </div>
      <div class="chart-mini" name="chartWords">
        <canvas id="testChart4"></canvas>
      </div>
      <div class="chart-mini" name="chartThemes">
        <canvas id="testChart1"></canvas>
      </div>
    </div>
    <div class="chart-one-row" name="chartWordsByThemes">
