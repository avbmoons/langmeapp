      <form class="modal-settings" id="settings" action="" method="get">
        <div class="info">
          <div class="info-header">
            ...
            <p class="modal-title">{{ __('Choose settings for your task') }}</p>
          ...
          <div class="info-main">
            <div class="combo-block" id="primLangBlock">
              <label class="combo-label" for="primLang">{{ __('Primary language') }}:</label>
              ...
              <div class="combo-list" id="primLangChoice">
                <div class="combo-list-item" name="choose">
                  ...
                  <button type="button" class="btn-choose" onclick="closePrimLangsChoiceList()">{{ __('Choose') }}</button>
                </div>
                <div class="combo-list-choice" id="primLangChoiceList"></div>
              </div>
            </div>
            <div class="combo-block" id="compLangBlock">
              <label class="combo-label" for="compLang">{{ __('Compared languages') }}:</label>
              ...
              <div class="combo-list" id="compLangChoice">
                <div class="combo-list-item" name="choose">
                  ...
                  <button type="button" class="btn-choose" onclick="closeCompLangsChoiceList()">{{ __('Choose') }}</button>
                </div>
                <div class="combo-list-choice" id="compLangChoiceList"></div>
              </div>
            </div>
            <div class="combo-block" id="themesBlock">
              <label class="combo-label" for="themeList">{{ __('Themes') }}:</label>
              ...
              <div class="combo-list" id="themeChoice">
                <div class="combo-list-item" name="themeList">
                  ...
                  <button type="button" class="btn-choose" onclick="closeThemesChoiceList()">{{ __('Choose') }}</button>
                </div>
            ...
            <div class="combo-block" id="modeButtonsBlock">
              ...
              <p class="combo-label mode">{{ __('Mode') }}:</p>
          ...
          <div class="info-button">
            <button type="button" class="btn-go" id="btnSubmitTaskSettings" >{{ __('Confirm') }}</button>
          </div>
        </div>
      </form>
