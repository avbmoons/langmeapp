  ...
  <div class="footer-center-front">
    <div class="footer-center-block-front">
      ...
      <menu-front class="menu-front" id="menuSocials">
        <button class="menu-item-front footer" name="btn-github" id="btnGithub">
        ...
        <button class="menu-item-front footer" name="btn-telegram" id="btnTelegram">
          <a class="btn-link-menu" href="">
            <svg
              width="24"
              height="24"
        ...
        <button class="menu-item-front footer" name="btn-whatsapp" id="btnWhatsapp">
          <a class="btn-link-menu" href="">
            <svg
              width="24"
              height="24"
